...
echo_and_run cd "/home/robocon-dr1/bot_ws/src/rosserial/rosserial_arduino"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/robocon-dr1/bot_ws/src/rosserial/rosserial_arduino/setup.py" \
     \
    build --build-base "/home/robocon-dr1/bot_ws/build/rosserial/rosserial_arduino" \
    install \
    --root="${DESTDIR-/}" \
