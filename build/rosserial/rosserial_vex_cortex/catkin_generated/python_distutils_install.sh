...
echo_and_run cd "/home/robocon-dr1/bot_ws/src/rosserial/rosserial_vex_cortex"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/robocon-dr1/bot_ws/src/rosserial/rosserial_vex_cortex/setup.py" \
     \
    build --build-base "/home/robocon-dr1/bot_ws/build/rosserial/rosserial_vex_cortex" \
    install \
    --root="${DESTDIR-/}" \
