...
echo_and_run cd "/home/robocon-dr1/bot_ws/src/rosserial/rosserial_python"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/robocon-dr1/bot_ws/src/rosserial/rosserial_python/setup.py" \
     \
    build --build-base "/home/robocon-dr1/bot_ws/build/rosserial/rosserial_python" \
    install \
    --root="${DESTDIR-/}" \
