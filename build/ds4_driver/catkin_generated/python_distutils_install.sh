...
echo_and_run cd "/home/robocon-dr1/bot_ws/src/ds4_driver"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/robocon-dr1/bot_ws/src/ds4_driver/setup.py" \
     \
    build --build-base "/home/robocon-dr1/bot_ws/build/ds4_driver" \
    install \
    --root="${DESTDIR-/}" \
